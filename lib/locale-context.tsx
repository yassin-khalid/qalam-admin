...
const translations: Record<Locale, Record<string, string>> = {
    en: {
        ...
        "teachers.canBeActivatedHint": "All required documents approved — the teacher is ready to be activated.",
        "teachers.cannotBeActivatedHint": "All required documents must be approved to activate this teacher.",
        "teachers.teacherActive": "Teacher Active",
        "teachers.teacherActiveHint": "All required documents are approved and the teacher account is active.",
        "teachers.activateTeacher": "Activate Teacher",
        "teachers.activationAutomaticHint": "Activation is automatic once all required documents are approved. Status refreshed.",
        "teachers.teacherActivatedSuccess": "Teacher activated — all required documents approved.",
    ...
    ar: {
        ...
        "teachers.canBeActivatedHint": "تم اعتماد جميع الوثائق المطلوبة — المعلم جاهز للتفعيل.",
        "teachers.cannotBeActivatedHint": "يجب اعتماد جميع الوثائق المطلوبة لتفعيل هذا المعلم.",
        "teachers.teacherActive": "المعلم نشط",
        "teachers.teacherActiveHint": "تم اعتماد جميع الوثائق المطلوبة وحساب المعلم نشط.",
        "teachers.activateTeacher": "تفعيل المعلم",
        "teachers.activationAutomaticHint": "يتم التفعيل تلقائياً بعد اعتماد جميع الوثائق المطلوبة. تم تحديث الحالة.",
        "teachers.teacherActivatedSuccess": "تم تفعيل المعلم — تم اعتماد جميع الوثائق المطلوبة.",
